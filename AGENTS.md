...
|---|---|---|---|
| `ldaca_wordflow` | `main` | `v0.7.5` | `main` (renamed from `dev` on 2026-08-25; the old `main` was deleted) is the integration source of truth; Binder still installs an exact published release from `binder/environment.yml` |
...
- **Wordflow** (formerly `ldaca-web-app`): `main` (the former `dev`, renamed 2026-08-25) is the integration source of truth and `v0.7.5` is the current published release pinned by this Binder repository.
