...
- Package: `ldaca-wordflow@0.7.1` (annotation comparison filtering/highlighting and codebook terminology; the Binder launch is repaired for the v0.7 line — see "What's new" below)
- ARDC BinderHub: [![Binder](https://mybinder.org/badge_logo.svg)](https://binderhub.rc.nectar.org.au/v2/gh/Australian-Text-Analytics-Platform/LDaCa_Text_Analytics_Tools/dev?labpath=index.ipynb)
- Desktop app (v0.7.0 — latest desktop build; v0.7.1 installers not yet published) — bundled installers that include the backend runtime: [Windows](https://github.com/Australian-Text-Analytics-Platform/ldaca-wordflow/releases/download/v0.7.0/ldaca-wordflow_0.7.0_windows-x86_64.msi) · [macOS (Apple Silicon)](https://github.com/Australian-Text-Analytics-Platform/ldaca-wordflow/releases/download/v0.7.0/ldaca-wordflow_0.7.0_darwin-aarch64.dmg)
...
| --- | --- | --- | --- | --- | --- |
| 2026-07-29 | `0.7.1` | [Open notebook](https://binderhub.rc.nectar.org.au/v2/gh/Australian-Text-Analytics-Platform/LDaCa_Text_Analytics_Tools/dev?labpath=index.ipynb) | — (use v0.7.0) | — (use v0.7.0) | `uvx --refresh ldaca-wordflow@0.7.1` |
